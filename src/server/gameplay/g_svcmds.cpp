...
g_svcmds.cpp (Game Server Commands) - modernized C++ Responsibilities: - ServerCommand(): dispatch "sv" console/RCON commands - IP filtering: addip/removeip/listip/writeip - G_FilterPacket(): packet gate using configured filters*/
