...
#include "../g_local.hpp"
#include "m_hornet.hpp"
#include "m_flash.hpp"

// [Paril-KEX]
constexpr SpawnFlags SPAWNFLAG_BOSS2_N64 = 8_spawnflag;
...
MonsterFrame boss2_frames_stand[] = {
	{ ai_stand },
	{ ai_stand },
	{ ai_stand },
	{ ai_stand },
...
MonsterFrame boss2_frames_walk[] = {
	{ ai_walk, 10 },
	{ ai_walk, 10 },
	{ ai_walk, 10 },
	{ ai_walk, 10 },
...
MonsterFrame boss2_frames_attack_pre_mg[] = {
	{ ai_charge, 2 },
	{ ai_charge, 2 },
	{ ai_charge, 2 },
	{ ai_charge, 2 },
...
// Loop this
MonsterFrame boss2_frames_attack_mg[] = {
...
static void Boss2HyperBlaster(gentity_t *self) {
	...
	Vector3 start;
	MonsterMuzzleFlashID id = (self->s.frame & 1) ? MZ2_BOSS2_MACHINEGUN_L2 : MZ2_BOSS2_MACHINEGUN_R2;
...
MonsterFrame boss2_frames_attack_hb[] = {
...
MonsterFrame boss2_frames_attack_post_mg[] = {
	{ ai_charge, 2 },
	{ ai_charge, 2 },
	{ ai_charge, 2 },
	{ ai_charge, 2 }
...
MonsterFrame boss2_frames_attack_rocket[] = {
	{ ai_charge, 2 },
	{ ai_charge, 2 },
	{ ai_charge, 2 },
	{ ai_charge, 2 },
...
MonsterFrame boss2_frames_attack_rocket2[] = {
...
MonsterFrame boss2_frames_pain_heavy[] = {
	{ ai_move },
	{ ai_move },
	{ ai_move },
	{ ai_move },
...
MonsterFrame boss2_frames_pain_light[] = {
	{ ai_move },
	{ ai_move },
	{ ai_move },
	{ ai_move }
...
MonsterFrame boss2_frames_death[] = {
...
static PAIN(boss2_pain) (gentity_t *self, gentity_t *other, float kick, int damage, const MeansOfDeath &mod) -> void {
...
static DIE(boss2_die) (gentity_t *self, gentity_t *inflictor, gentity_t *attacker, int damage, const Vector3 &point, const MeansOfDeath &mod) -> void {
	if (self->spawnFlags.has(SPAWNFLAG_MONSTER_CORPSE)) {
		// check for gib
