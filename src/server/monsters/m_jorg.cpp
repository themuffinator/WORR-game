...
MonsterFrame jorg_frames_stand[] = {
...
MonsterFrame jorg_frames_pain3[] = {
	{ ai_move, -28 },
	{ ai_move, -6 },
...
MonsterFrame jorg_frames_pain2[] = {
	{ ai_move },
	{ ai_move },
	{ ai_move }
};
...
MonsterFrame jorg_frames_pain1[] = {
	{ ai_move },
	{ ai_move },
	{ ai_move }
};
...
MonsterFrame jorg_frames_death1[] = {
...
MonsterFrame jorg_frames_attack2[] = {
	{ ai_charge },
	{ ai_charge },
	{ ai_charge },
	{ ai_charge },
...
MMOVE_T(jorg_move_attack2) = { FRAME_attack201, FRAME_attack213, jorg_frames_attack2, jorg_run };

MonsterFrame jorg_frames_start_attack1[] = {
	{ ai_charge },
	{ ai_charge },
	{ ai_charge },
	{ ai_charge },
...
MMOVE_T(jorg_move_start_attack1) = { FRAME_attack101, FRAME_attack108, jorg_frames_start_attack1, jorg_attack1 };

MonsterFrame jorg_frames_attack1[] = {
...
MMOVE_T(jorg_move_attack1) = { FRAME_attack109, FRAME_attack114, jorg_frames_attack1, jorg_reattack1 };

MonsterFrame jorg_frames_end_attack1[] = {
	{ ai_move },
	{ ai_move },
	{ ai_move },
	{ ai_move }
};
MMOVE_T(jorg_move_end_attack1) = { FRAME_attack115, FRAME_attack118, jorg_frames_end_attack1, jorg_run };
...
static PAIN(jorg_pain) (gentity_t *self, gentity_t *other, float kick, int damage, const MeansOfDeath &mod) -> void {
	...
	if (mod.id != ModID::Chainfist) {
		...
		*/
		...
		if ((self->s.frame >= FRAME_attack101) && (self->s.frame <= FRAME_attack108))
			if (frandom() <= 0.005f)
				return;

		if ((self->s.frame >= FRAME_attack109) && (self->s.frame <= FRAME_attack114))
			if (frandom() <= 0.00005f)
				return;

		if ((self->s.frame >= FRAME_attack201) && (self->s.frame <= FRAME_attack208))
			if (frandom() <= 0.005f)
				return;
	}
...
static DIE(jorg_die) (gentity_t *self, gentity_t *inflictor, gentity_t *attacker, int damage, const Vector3 &point, const MeansOfDeath &mod) -> void {
...
/*QUAKED monster_jorg (1 .5 0) (-80 -80 0) (90 90 140) AMBUSH TRIGGER_SPAWN SIGHT x CORPSE x x x NOT_EASY NOT_MEDIUM NOT_HARD NOT_DM NOT_COOP
 */
